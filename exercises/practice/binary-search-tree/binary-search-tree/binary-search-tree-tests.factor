...
"can sort single number" print
{ { "2" } }
[ { "2" } <bst> sorted-data ] unit-test

"can sort if second number is smaller than first" print
{ { "1" "2" } }
[ { "2" "1" } <bst> sorted-data ] unit-test

"can sort if second number is same as first" print
{ { "2" "2" } }
[ { "2" "2" } <bst> sorted-data ] unit-test

"can sort if second number is greater than first" print
{ { "2" "3" } }
[ { "2" "3" } <bst> sorted-data ] unit-test

"can sort complex tree" print
{ { "1" "2" "3" "5" "6" "7" } }
