...
"one item, too heavy" description
{ 0 }
[ 10 { T{ item { weight 100 } { value 1 } } } maximum-value ] unit-test

"five items (cannot be greedy by weight)" description
{ 21 }
...
"five items (cannot be greedy by value)" description
{ 80 }
