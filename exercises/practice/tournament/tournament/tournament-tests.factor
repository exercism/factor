...
"just the header if no input" description
{ { "Team                           | MP |  W |  D |  L |  P" } }
[ { } tally ] unit-test

STOP-HERE

"a win is three points, a loss is zero points" description
...
"a win can also be expressed as a loss" description
{ { "Team                           | MP |  W |  D |  L |  P" "Allegoric Alaskans             |  1 |  1 |  0 |  0 |  3" "Blithering Badgers             |  1 |  0 |  0 |  1 |  0" } }
[ { "Blithering Badgers;Allegoric Alaskans;loss" } tally ] unit-test

"a different team can win" description
...
"a draw is one point each" description
...
"There can be more than one match" description
...
"There can be more than one winner" description
...
"There can be more than two teams" description
...
"incomplete competition (not all pairs have played)" description
...
"ties broken alphabetically" description
...
"ensure points sorted numerically" description
